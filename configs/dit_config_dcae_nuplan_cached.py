# Configuration for Epona with KV Cache Support
# Based on dit_config_dcae_nuplan.py with additional caching parameters
...
# ============================================
# KV Cache Configuration (New Parameters)
# ============================================
...
# -1 for global attention (cache all history)
# Positive integer for local attention window (e.g., 21 for 21-frame window)
local_attn_size=-1

# Sink size: number of initial tokens to always keep in cache
# Useful for preserving important context tokens
sink_size=0

# Number of frames to process per block during generation
# 1 is recommended for frame-by-frame generation
